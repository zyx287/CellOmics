...
class LARS(Optimizer):
    ...
    From https://arxiv.org/abs/1708.03888
    params (iterable): iterable of parameters to optimize or dicts defining
        ...
        weight_decay (float, optional): weight decay (L2 penalty) (default: 0.0)
            ("\beta")
    '''
    def __init__(self, params, lr, len_reduced, momentum=0.9, 
                 use_nesterov=False, weight_decay=0.0, 
                 classic_momentum=True, eta=0.001) -> None:
        self.epoch = 0
        defaults = dict(
            lr=lr,
    ...
    def step(self, epoch=None, closure=None):
        ...
        for group in self.param_groups:
            # Setting different learning rate for different groups
            ...
            for p in group['params']:
                ...
                if self.classic_momentum:
                    ...
                    # Calculate trust ratio for tuning learning rate
                    #(self.eta * w_norm / g_norm) if g_norm > 0 and w_norm > 0 else 1.0
...
# Decorator for LARS
'''
Didn't using (Optimizers), but using decorator to simplify the code
'''
